...
`/home/claude/autobleem-repo` on the build server. `docs/repo-server-plan.md` has the layout of that
directory and the tools that write it; this folder is only the server.
